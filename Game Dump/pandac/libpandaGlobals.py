...
def __mul__(*_args):
    ...
    if numArgs == 2:
        ...
        raise TypeError, 'Invalid argument 0, expected one of: <Vec3D.Vec3D> <Vec3.Vec3> <Vec2D.Vec2D> <Vec2.Vec2> <VBase4D.VBase4D> <VBase4.VBase4> <Point3D.Point3D> <VBase3D.VBase3D> <Point3.Point3> <VBase3.VBase3> <Point2D.Point2D> <Point2.Point2> <Mat4D.Mat4D> <Mat4.Mat4> <Mat3D.Mat3D> <Mat3.Mat3> '
    else:
        raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 2 '
