...
class Playground(Place.Place):
    ...
    def enterTeleportIn(self, requestStatus):
        ...
        if base.localAvatar.hp < 1:
            ...
            if Quests.avatarHasTrolleyQuest(base.localAvatar) and Quests.avatarHasFirstCogQuest(base.localAvatar) and Quests.avatarHasFriendQuest(base.localAvatar) and Quests.avatarHasPhoneQuest(base.localAvatar) and Quests.avatarHasCompletedPhoneQuest(base.localAvatar) and self.loader.hood.id == ToontownGlobals.ToontownCentral:
                requestStatus['nextState'] = 'popup'
                ...
                print '### Playground - making dialog'
                self.dialog = TTDialog.TTDialog(text = msg, command = self._Playground__cleanupDialog, style = TTDialog.Acknowledge)
    ...
    def enterPopup(self, teleportIn = 0):
        ...
        base.localAvatar.startSleepWatch(self._Playground__handleFallingAsleepPopup)
