...
TrickHeals = {
    ...
    Tricks.BALK: 0 }
TrickSounds = {
    Tricks.BACKFLIP: 'phase_5.5/audio/sfx/backflip.mp3',
    Tricks.ROLLOVER: 'phase_5.5/audio/sfx/rollover.mp3',
    Tricks.PLAYDEAD: 'phase_5.5/audio/sfx/play_dead.mp3',
    Tricks.BEG: 'phase_5.5/audio/sfx/beg.mp3',
    Tricks.DANCE: 'phase_5.5/audio/sfx/heal_dance.mp3',
    Tricks.JUMP: 'phase_5.5/audio/sfx/jump.mp3',
    Tricks.SPEAK: 'phase_5.5/audio/sfx/speak_v1.mp3' }
