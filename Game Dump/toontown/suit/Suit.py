...
class Suit(Avatar.Avatar):
    ...
    def generateCorporateTie(self, modelPath = None):
        ...
        if dept == 'c':
            tieTex = loader.loadTexture('phase_9/maps/cog_robot_tie_boss.jpg')
        elif dept == 's':
            tieTex = loader.loadTexture('phase_9/maps/cog_robot_tie_sales.jpg')
        elif dept == 'l':
            tieTex = loader.loadTexture('phase_9/maps/cog_robot_tie_legal.jpg')
        elif dept == 'm':
            tieTex = loader.loadTexture('phase_9/maps/cog_robot_tie_money.jpg')
